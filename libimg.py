...
from bufimage import BufRefImage
...
def array_to_qt_image(arr, share_memory=True, format = None):
    """ Creates QBugImage from a numpy array.
        ...
        It returns a BufRefImage, which is a descendant from QImage, to ensure
        that a reference to the buffer exists and isn't garbage collected.
    ...
    qimg = BufRefImage(buf, arr_width, arr_height, format) 
    return qimg
